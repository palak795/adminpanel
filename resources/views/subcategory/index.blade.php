...
@foreach($cruds as $crud) 
        ...
        <tr border="none"> 
            ...
            <td>{{$crud->subcategory_name}}</td> 


<td> 

    <form action="{{ route('subcategory.destroy', $crud->id)}}" method="post">
...
<form action="{{ route('subcategory.edit', $crud->id)}}" method="GET"> 
